const res = await fetch('http://127.0.0.1:9225/json/new?http://127.0.0.1:3636/', { method: 'PUT' });
...
const r = await send('Runtime.evaluate',{expression:`
  (() => { const f = document.getElementById('cardForm').elements;
    ...
    return { diy: f.diy.value, showDiy: f.showDiy.checked }; })()`,returnByValue:true});
console.log('脚注默认值:', r.result.result.value);
